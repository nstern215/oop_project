...
public:
	...
	virtual bool handleCollision(King* item)= 0;
	virtual bool handleCollision(Mage* item)= 0;
	virtual bool handleCollision(Warrier* item)= 0;
	virtual bool handleCollision(Thief* item)= 0;
